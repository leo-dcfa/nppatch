...
const DONATION_ELEVATE_RECURRING_ID_FIELD = {
    fieldApiName: "Donation_Elevate_Recurring_ID__c",
...
const PAYMENT_CARD_EXPIRATION_MONTH_FIELD = {
    fieldApiName: "Payment_Card_Expiration_Month__c",
    objectApiName: "DataImport__c",
};
const PAYMENT_CARD_EXPIRATION_YEAR_FIELD = {
    fieldApiName: "Payment_Card_Expiration_Year__c",
    objectApiName: "DataImport__c",
};
...
const PAYMENT_ELEVATE_CREATED_DATE_FIELD = {
    fieldApiName: "Payment_Elevate_Created_Date__c",
    objectApiName: "DataImport__c",
};
const PAYMENT_ELEVATE_CREATED_UTC_TIMESTAMP_FIELD = {
    fieldApiName: "Payment_Elevate_Created_UTC_Timestamp__c",
    objectApiName: "DataImport__c",
};
const PAYMENT_ELEVATE_ID_FIELD = { fieldApiName: "Payment_Elevate_ID__c", objectApiName: "DataImport__c" };
const PAYMENT_ELEVATE_ORIGINAL_PAYMENT_ID_FIELD = {
...
const RECURRING_DONATION_ELEVATE_RECURRING_ID_FIELD = {
...
const RECURRING_DONATION_ACH_LAST_4__C = {
    fieldApiName: "Recurring_Donation_ACH_Last_4__c",
    objectApiName: "DataImport__c",
};
const RECURRING_DONATION_CARD_EXPIRATION_MONTH__C = {
    fieldApiName: "Recurring_Donation_Card_Expiration_Month__c",
    objectApiName: "DataImport__c",
};
const RECURRING_DONATION_CARD_EXPIRATION_YEAR__C = {
    fieldApiName: "Recurring_Donation_Card_Expiration_Year__c",
    objectApiName: "DataImport__c",
};
const RECURRING_DONATION_CARD_LAST_4__C = {
    fieldApiName: "Recurring_Donation_Card_Last_4__c",
    objectApiName: "DataImport__c",
};
const RECURRING_DONATION_ELEVATE_EVENT_VERSION__C = {
