...
jest.mock("@salesforce/apex/RD2_StatusAutomationSettings_CTRL.getAutomationSettings", () => ({ default: jest.fn() }), {
    virtual: true,
});

jest.mock(
    "@salesforce/apex/RD2_StatusAutomationSettings_CTRL.saveStatusAutomationSettings",
    () => ({ default: jest.fn() }),
    { virtual: true }
);
